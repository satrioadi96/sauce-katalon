...
WebUI.setText(findTestObject('Object Repository/SAP6-06/Page_Swag Labs/input_firstName'), '')

WebUI.setText(findTestObject('Object Repository/SAP6-06/Page_Swag Labs/input_lastName'), '')

WebUI.setText(findTestObject('Object Repository/SAP6-06/Page_Swag Labs/input_postalCode'), '')

WebUI.click(findTestObject('Object Repository/SAP6-06/Page_Swag Labs/input_continue'))

WebUI.click(findTestObject('Object Repository/SAP6-06/Page_Swag Labs/div_error-message-container error'))
